            ...
            <WindowWrap name={T("jumbo.successes.and.achievements")} noPadding>
                <Grid container spacing={1}>
                    <Grid item xs={12} md={4}>
                        <img className="brimg" src="banner.successes.png" width="100%" height="100%" style={{ objectFit: "cover", objectPosition: "0px 0px" }}></img>
                    </Grid>
                    <Grid item xs={12} md={8}>
                        <Grid container>

                            <Grid item xs={12}>
                                <Typography variant="h4" sx={{ marginTop: "30px", textAlign: "center" }}>{T("jumbo.achievements")}</Typography>
                            </Grid>
